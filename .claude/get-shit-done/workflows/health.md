...
```bash
node "D:/Viblink/.claude/get-shit-done/bin/gsd-tools.cjs" validate health $REPAIR_FLAG
```
...
```bash
node "D:/Viblink/.claude/get-shit-done/bin/gsd-tools.cjs" validate health
```
